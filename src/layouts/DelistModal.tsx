...
const LINK =
  "https://docs.mirror.finance/protocol/mirrored-assets-hassets#delisting-and-migration"
  ...
  const contents = {
    DELIST: {
      ...
      details: [
        ...
        `If you want to close your borrowed position immediately, make sure that you acquire a sufficient amount of hAsset before delisting.`,
      ],
    },
    STOCKEVENT: {
