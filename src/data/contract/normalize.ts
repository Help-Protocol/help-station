...
/* KARMA Price */
export const KARMAPriceQuery = selector({
  key: "KARMAPrice",
  get: ({ get }) => {
...
export const KARMAPriceState = atom({
  key: "KARMAPriceState",
  default: "0",
})
...
/* store: KARMA Price */
export const useKARMAPrice = () => {
  return useStoreLoadable(KARMAPriceQuery, KARMAPriceState)
}
