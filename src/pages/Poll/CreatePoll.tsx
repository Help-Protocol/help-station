...
const polls: Record<PollType, { title: string; desc: string }> = {
  ...
  [PollType.TEXT_WHITELIST]: {
    title: "Whitelist a new hAsset",
    desc: "Submit a poll to whitelist a new hAsset",
  },
  [PollType.TEXT_PREIPO]: {
    title: "Whitelist a Pre-IPO hAsset",
    desc: "Submit a poll to whitelist a new Pre-IPO asset",
  },
  [PollType.WHITELIST]: {
    title: "Register whitelist parameters",
    desc: "Register the parameters for a newly whitelisted hAsset",
  },
  [PollType.PREIPO]: {
  ...
  [PollType.DELIST]: {
    title: "Delist hAsset",
    desc: "Vote for an hAsset to be delisted from Help Protocol",
  },
  [PollType.INFLATION]: {
    title: "Modify weight parameter",
    desc: "Modify reward distribution parameter of an existing hAsset",
  },
  [PollType.MINT_UPDATE]: {
    title: "Modify mint parameters",
    desc: "Modify the mint parameters of an existing hAsset",
  },
  [PollType.GOV_UPDATE]: {
